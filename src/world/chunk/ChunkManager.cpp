...
ChunkManager::ChunkManager() : shader_((AssetManager::Instance().GetPath() + "shaders/shader.vert").data(), (AssetManager::Instance().GetPath() + "shaders/shader.frag").data()), texture_(AssetManager::Instance().GetPath() + "textures/blocks/block_atlas.png", true, true, GL_REPEAT, GL_NEAREST)
{
